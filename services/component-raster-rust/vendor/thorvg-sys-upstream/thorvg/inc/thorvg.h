...
enum struct SceneEffect : uint8_t
{
    ...
    ColorMatrix        ///< Apply an SVG feColorMatrix type="matrix" to the scene content. Param(20) = the 4x5 row-major matrix (20 doubles); applied to straight sRGB RGBA channels, output premultiplied back.
};
