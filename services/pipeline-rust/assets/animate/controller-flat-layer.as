package BoAEnergy_fla
{
   ...
   public dynamic class Symbol11_3 extends MovieClip
   {
      ...
      public var scrolling:MovieClip;
      
      public var scrolling_prop_:MovieClip;
      ...
      public function Symbol11_3()
      {
         super();
         addFrameScript(0,this.frame1);
         this.__setProp_scrolling_Symbol11_scrolling_obj__0();
         this.__setProp_scrolling_prop__Symbol11_scrolling_prop__0();
      }
      ...
      internal function __setProp_scrolling_Symbol11_scrolling_obj__0() : *
      {
         try
         {
            this.scrolling["componentInspectorSetting"] = true;
         }
         catch(e:Error)
         {
         }
         this.scrolling.containerType = 2;
         try
         {
            this.scrolling["componentInspectorSetting"] = false;
         }
         catch(e:Error)
         {
         }
      ...
      internal function __setProp_scrolling_prop__Symbol11_scrolling_prop__0() : *
      {
         try
         {
            this.scrolling_prop_["componentInspectorSetting"] = true;
         }
         catch(e:Error)
         {
         }
         this.scrolling_prop_.containerType = 1;
         this.scrolling_prop_.isAttachedToCamera = false;
         this.scrolling_prop_.isAttachedToMask = false;
         this.scrolling_prop_.layerDepth = 0;
         this.scrolling_prop_.layerIndex = 0;
         this.scrolling_prop_.maskLayerName = "";
         try
         {
            this.scrolling_prop_["componentInspectorSetting"] = false;
         }
         catch(e:Error)
         {
         }
