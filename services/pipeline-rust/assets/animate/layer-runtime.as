package privatePkg
{
   ...
   public class ___LayerProp___ extends MovieClip
   {
      ...
      public static function executeFrameHelper(param1:MovieClip) : *
      {
         ...
         {
            _loc4_ = graphicFrameSync(_loc2_.currentFrame,_loc3_.totalFrames,_loc2_["firstFrame"],_loc2_["lastFrame"],_loc2_["loopMode"]);
         ...
         {
            _loc6_ = _loc3_.getChildByName("_mask_obj_instance");
            if(_loc6_ != null)
            {
         ...
         {
            _loc7_ = _loc3_.getChildAt(_loc5_);
            if((Boolean(_loc7_)) && Boolean(_loc7_.hasOwnProperty("loopMode")))
            {
               _loc7_.syncFrame();
            }
            _loc5_++;
      ...
      private static function maxNum(param1:Number, param2:Number) : *
      {
         return param1 > param2 ? param1 : param2;
      }
      
      private static function minNum(param1:Number, param2:Number) : *
      {
         return param1 < param2 ? param1 : param2;
      }
      
      private static function graphicFrameSync(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number) : Number
      {
         var _loc7_:* = undefined;
         var _loc6_:* = param1;
         if(param4 <= 0)
         {
            if(param5 == 0)
            {
               _loc6_ = (param1 + param3 - 2) % param2 + 1;
            }
            else if(param5 == 1)
            {
               _loc6_ = param1 + param3 - 1;
               if(_loc6_ > param2)
               {
                  _loc6_ = param2;
               }
            ...
            {
               _loc6_ = (param3 + param2 - param1 % param2) % param2 + 1;
            }
         }
         else
         {
            ...
            {
               _loc7_ = param4 - param3 + 1;
               if(_loc7_ < 0)
               {
                  _loc7_ += param2;
               }
            }
            else if(param5 == 3 || param5 == 4)
            {
               _loc7_ = param3 - param4 + 1;
               if(_loc7_ < 0)
               {
                  _loc7_ += param2;
               }
            ...
            if(param5 == 0)
            {
               _loc6_ = (param3 + param1 % _loc7_) % param2;
            }
            else if(param5 == 1)
            {
               _loc6_ = (param3 + minNum(param1,_loc7_ - 1)) % param2;
            }
            else if(param5 == 2)
            {
               _loc6_ = param3;
            ...
            {
               _loc6_ = param3 - minNum(param1,_loc7_ - 1);
               if(_loc6_ < 0)
               {
                  _loc6_ += param2;
               }
      ...
      private static function applyZDepthAndColorEffectsHelper(param1:MovieClip) : void
      {
         ...
         var _loc8_:Number = 0;
         var _loc9_:Number = 0;
         if(Boolean(_loc5_) && !param1.isAttachedToCamera)
         {
         ...
         else
         {
            ...
            {
               _loc11_ = getProjectionMatrix(param1,param1.layerDepth);
               if(_loc11_)
               {
                  _loc11_.invert();
            ...
            _loc10_ = getProjectionMatrix(param1,_loc8_);
            if(_loc10_)
            {
         ...
         {
            _loc12_ = _loc4_.getChildByName("_mask_obj_instance");
            if(_loc12_ != null)
            {
               _loc8_ = -_loc9_;
               _loc6_.invert();
               ...
               {
                  _loc14_ = param1.parent.getChildByName(param1.maskLayerName);
                  if(_loc14_)
                  {
                     _loc8_ += _loc14_.z;
                  }
                  if(Boolean(_loc14_) && !param1.isAttachedToCamera)
                  {
      ...
      private function resetStage(param1:Event) : void
      {
         ...
         if((Boolean(_loc6_)) && (Boolean(MovieClip(root).scenes.length > 1 || !parent.parent || currentFrame < MovieClip(parent).totalFrames)) && parent == root)
         {
